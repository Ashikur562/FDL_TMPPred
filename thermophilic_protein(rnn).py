# -*- coding: utf-8 -*-
"""Thermophilic Protein(RNN).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wj_xe_hGEPlTeYG10ibRUm-nUmACILBM
"""
...
file_name = r'/kaggle/working/model-8-result.csv'
validation_file = r'/kaggle/working/model-8-validation.csv'
...
from tensorflow.keras.models import Sequential
from tensorflow.keras.layers import SimpleRNN, MaxPooling1D, BatchNormalization, Flatten, Dense
from tensorflow.keras.optimizers import Adam

def build_model(input_shape, rnn_units=32, pool_size=2, learning_rate=1e-3):
    """
    Function to define an RNN model using SimpleRNN and pooling layers.

    Args:
        input_shape (tuple): Shape of the input data (e.g., (num_features, 1)).
        rnn_units (int): Number of units in the SimpleRNN layers.
    ...
    # Second RNN Layer without return sequences
...
history = final_model.fit(xtrain_cnn, ytrain_cnn, epochs=ephocs, batch_size=batch_size, validation_split=0.1,
