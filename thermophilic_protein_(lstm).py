# -*- coding: utf-8 -*-
"""Thermophilic Protein (LSTM).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bIXdUBOcseJfSZgVnaetEi4DlS7uOWnB
"""
...
file_name = r'/kaggle/working/model-4-result.csv'
validation_file = r'/kaggle/working/model-4-validation.csv'
...
def build_model(input_shape, lstm_units=32, dense_units=64, dropout_rate=0.3, learning_rate=1e-3):
    """
    Function to define an LSTM model with multiple layers and dropout regularization.
...
for train_index, val_index in kf.split(xtrain_cnn):
    ...
    validation_metrics = func(model, f"APAAC_Model4_Fold_{fold_no}", X_val, y_val)
...
test_metrics = total_matric_cal(ytest_cnn, y_pred_classes, pred, "APAAC_Model4_Test_Set")
print("\nTest Set Metrics:")
print(test_metrics)
...
for train_index, val_index in kf.split(xtrain_cnn):
    ...
    # Evaluate on validation fold using func()
    validation_metrics = func(model, f"CTDC_Model4_Fold_{fold_no}", X_val, y_val)
    all_validation_metrics = pd.concat([all_validation_metrics, validation_metrics], ignore_index=True)
...
test_metrics = total_matric_cal(ytest_cnn, y_pred_classes, pred, "CTDC_Model4_Test_Set")
print("\nTest Set Metrics:")
print(test_metrics)
...
for train_index, val_index in kf.split(xtrain_cnn):
    ...
    # Evaluate on validation fold using func()
    validation_metrics = func(model, f"DDE_Model4_Fold_{fold_no}", X_val, y_val)
    all_validation_metrics = pd.concat([all_validation_metrics, validation_metrics], ignore_index=True)
...
test_metrics = total_matric_cal(ytest_cnn, y_pred_classes, pred, "DDE_Model4_Test_Set")
print("\nTest Set Metrics:")
print(test_metrics)
...
for train_index, val_index in kf.split(xtrain_cnn):
    ...
    # Evaluate on validation fold using func()
    validation_metrics = func(model, f"DistancePair_Model4_Fold_{fold_no}", X_val, y_val)
    all_validation_metrics = pd.concat([all_validation_metrics, validation_metrics], ignore_index=True)
...
test_metrics = total_matric_cal(ytest_cnn, y_pred_classes, pred, "DistancePair_Model4_Test_Set")
print("\nTest Set Metrics:")
print(test_metrics)